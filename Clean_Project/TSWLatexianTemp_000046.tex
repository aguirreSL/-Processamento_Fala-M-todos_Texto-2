...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Trabalho rápido 1 - Classificação de sinais - Sinais não estacionários.}
\author{Sergio Aguirre}

\hypersetup{
  pdfinfo={
	 Subject={Processamento digital, Classificação, Não estacionários},
   Keywords={Processamento digital, Classificação, Não estacionários}
  }
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\maketitle % Faça 1 pagina com o titulo
%\include{Capa}
\input{titlepage}
...
\fancyfoot[RO]{\includegraphics[height=1.2cm,page=1]{LogosUFSM.pdf}\hfill {\rule[1.6em]{.9\linewidth}{.1pt}}}
\fancyfoot[LE]{{\rule[1.6em]{.9\linewidth}{.1pt}}\hfill \includegraphics[height=1.2cm,page=1]{LogosUFSM.pdf}}
...
\section{Sinais Aleatórios não estacionários}
...
\bibliography{bibliografia,Books} % Arquivo com sua database
